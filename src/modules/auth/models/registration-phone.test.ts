...
describe("optional registration phone", () => {
  ...
  const input = { email: "person@example.com", password: "A long test password 1!", confirmPassword: "A long test password 1!", username: "Person", workspaceName: "Home", country: "", phone: "123" };
